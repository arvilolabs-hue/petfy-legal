# Design direction — Petfy x Arvilo Labs

The public site uses two registers. The landing page is a welcoming editorial introduction to Petfy, with the official mascot, warm cream, deep cocoa, and focused orange actions. The document pages switch to a calmer reading surface: fixed prose measure, a visible table of contents, strong section headings, and a clear contact path.

- **Color:** deep cocoa `#2d2420`, Petfy orange `#c0400a` (action), pale peach `#fff0e8`, warm paper `#fcfaf8`, neutral border `#eaded4`.
- **Typography:** system sans for UI and body; a rounded system display treatment for homepage headlines. No remote font requests.

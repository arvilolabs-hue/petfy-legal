...
- The public contact chosen by the owner is `arvilolabs@gmail.com`. The owner confirms that it receives messages and that they will monitor it for support, privacy, and deletion requests. The owner does not authorize publication of their personal phone, postal address, or name on this site.
...
- The owner's preference to display only Arvilo Labs may conflict with the obligation to identify the actual privacy controller in some launch regions. Record this as an unresolved release question, rather than describing an unregistered brand as a corporation.

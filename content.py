...
PAGES = {
    "privacy": {
        ...
        "sections": [
            (
                ...
                {
                    "es": "<p>Petfy se ofrece bajo la marca <strong>Arvilo Labs</strong>. Para consultas de privacidad, soporte o eliminación de cuenta, escribe a <a href='mailto:arvilolabs@gmail.com'>arvilolabs@gmail.com</a>.</p><p>Esta página cubre la app Petfy para iPhone y iPad y este sitio público. La identificación formal del responsable, requerida en algunos mercados, está pendiente de revisión antes de que este borrador sea una política vigente.</p>",
                    "en": "<p>Petfy is offered under the <strong>Arvilo Labs</strong> brand. For privacy, support, or account-deletion questions, email <a href='mailto:arvilolabs@gmail.com'>arvilolabs@gmail.com</a>.</p><p>This page covers the Petfy app for iPhone and iPad and this public site. The formal identity of the controller, required in some markets, remains under review before this draft can become an effective policy.</p>",
                },
            ),
            (
                "datos",
    ...
    "terms": {
        ...
        "sections": [
            ("servicio", {"es": "Petfy y tu cuenta", "en": "Petfy and your account"}, {"es": "<p>Petfy, ofrecida bajo la marca Arvilo Labs, permite organizar mascotas, cuidados, recordatorios, fotos, reportes, veterinarias cercanas y funciones opcionales de IA. Debes mantener segura tu cuenta y proporcionar información que tengas derecho a utilizar.</p><p>Petfy no fija una edad mínima adicional a escala mundial. El uso por menores deberá cumplir las autorizaciones y reglas locales aplicables; este punto requiere revisión antes de hacer vigentes las condiciones.</p>", "en": "<p>Petfy, offered under the Arvilo Labs brand, helps organize pets, care records, reminders, photos, reports, nearby vets, and optional AI features. Keep your account secure and provide information you have the right to use.</p><p>Petfy does not set an additional worldwide minimum age. Use by minors must comply with applicable local rules and authorizations; this point needs review before these terms become effective.</p>"}),
